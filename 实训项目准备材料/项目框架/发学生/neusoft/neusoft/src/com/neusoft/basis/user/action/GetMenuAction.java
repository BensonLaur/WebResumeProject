...
/**
 * Comments: Created:2012-12-16 Author: zhang shengbo CopyRight:yboffice
 */

public class GetMenuAction extends EbAction {
	private static final long serialVersionUID = -6349859121223997971L;
	...
	public String execute() throws Exception {
		...
		List<MenuItemEntity> menuItemEneities = userMapper
				.getUserMenuItem(((UserEntity) (getSession().get("user")))
						.getGroupId());
		String menuId = null;
		...
		for (MenuItemEntity menuItemEneity : menuItemEneities) {
			...
			menuBuf.append(" target=main>")
					.append(menuItemEneity.getItemName()).append("</a></td>");
			menuBuf.append("</tr>");
		}
