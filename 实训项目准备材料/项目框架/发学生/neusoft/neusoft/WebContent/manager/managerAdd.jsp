...
height:20px;padding-top:2px;border:1px solid #7F9DB9;color:#1E5494;width:200px;max-width: 205px;
	...
	<body>
        ...
        <form id="insertForm" action="<%=basePath%>manager/insertManager.action" style="margin: 0;padding: 0;" onsubmit="return true;" method="post">
			...
			<tbody>
				...
				<tr>
					...
					<td width="40%" class="td_bg" colspan="3">
						<input type="text" id="managerEntity.managerName" value="" name="managerEntity.managerName"/><label for="managerEntity.managerName"></label>
					</td>
				</tr>
				<tr>
					<td class="td_bg" width="10%" height="23">
